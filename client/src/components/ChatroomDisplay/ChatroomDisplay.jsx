...
import {displayChatRooms, fetchMessages, joinChatRoom, leaveChatRoom, sendMessage} from "../../redux/actions/chat";
import {checkAuth} from "../../redux/actions/auth";
import {ChatroomHeading} from "../ChatroomHeading";
/* ------ */


const ChatroomDisplay = ({ chatRooms, auth, sendMessage, joinChatRoom, leaveChatRoom, fetchMessages }) => {
...
export default connect(mapStateToProps, { sendMessage, checkAuth, joinChatRoom, leaveChatRoom, fetchMessages, displayChatRooms })(ChatroomDisplay);
